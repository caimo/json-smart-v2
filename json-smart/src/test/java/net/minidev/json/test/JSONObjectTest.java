...
class JSONObjectTest {
    ...
    void mergeJsonArrayWithObjectSuccess() {
        ...
        jsonArray1.merge(1);
        Assertions.assertEquals("[{\"k1\":\"v1\"},{\"k2\":\"v2\"},\"s1\",1]", jsonArray1.toJSONString());

        jsonArray1.merge(true);
        Assertions.assertEquals("[{\"k1\":\"v1\"},{\"k2\":\"v2\"},\"s1\",1,true]", jsonArray1.toJSONString());
        ...
        Assertions.assertEquals("[{\"k1\":\"v1\"},{\"k2\":\"v2\"},\"s1\",1,true,{\"k3\":\"v3\"}]", jsonArray1.toJSONString());
    }
}